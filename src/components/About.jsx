    ...
    <section id="about" className="section relative z-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-5xl font-black text-white">About <span className="gradient-text">Me</span></h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -top-8 -left-4 text-[120px] font-black text-[#0A84FF]/5 select-none leading-none">
                DEV
              </div>
              <h3 className="relative text-3xl font-bold text-white mb-5 leading-tight">
                Building the future with<br />
                <span className="gradient-text">AI + Web Technology</span>
              </h3>
              <p className="text-[#8B949E] leading-relaxed mb-4 text-base">
              ...
              <p className="text-[#8B949E] leading-relaxed mb-8 text-base">
              ...
              <div className="inline-flex items-center gap-3 px-5 py-3 rounded-md glass border border-[#0A84FF]/20">
                <span className="w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse" />
                <span className="text-white text-sm font-medium">Open to internships & freelance work</span>
              </div>
            </div>
          </motion.div>
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ x: 6 }}
                  className="flex items-center gap-4 p-4 rounded-lg glass border border-[#30363D]/50 hover:border-[#0A84FF]/30 transition-all duration-300"
                >
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-[#0A84FF]/10 border border-[#0A84FF]/20">
