...
export default function Experience() {
  return (
    <section id="experience" className="section relative z-10 overflow-hidden">
      {/* Blob — must stay inside overflow-hidden */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative">
        ...
        <div className="max-w-4xl mx-auto relative">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 z-10">
                      <div className="w-4 h-4 rounded-full bg-[#0A84FF] border-2 border-[#050709]"
          ...
          {/* MOBILE timeline (below md) — single column left rail */}
          <div className="md:hidden relative pl-7">
            <div className="absolute left-2 top-0 bottom-0 w-px bg-gradient-to-b from-[#0A84FF] via-[#30363D] to-transparent" />
            <div className="flex flex-col gap-7">
              {experience.map(function(item, i) {
                return (
                  ...
                  >
                    {/* Dot */}
                    <div className="absolute -left-[1.45rem] top-5 z-10">
                      <div className="w-3 h-3 rounded-full bg-[#0A84FF] border-2 border-[#050709]"
                        style={{ boxShadow: "0 0 10px rgba(10,132,255,0.6)" }} />
                    </div>
                    <div className="glass grad-border rounded-xl p-4">
                      ...
                      <h3 className="text-white font-bold text-sm mb-0.5">{item.role}</h3>
                      <p className="font-semibold text-xs mb-2 text-[#0A84FF]">{item.company}</p>
                      <p className="text-[#8B949E] text-xs leading-relaxed mb-3">{item.description}</p>
                      <div className="flex flex-wrap gap-1.5">
                        {item.techs.map(function(tech) {
                          return (
                            <span key={tech} className="text-xs px-2 py-0.5 rounded font-mono bg-[#0D1117] border border-[#30363D] text-[#8B949E]">
                              {tech}
                            </span>
                          );
                        })}
